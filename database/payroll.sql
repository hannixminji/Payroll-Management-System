...
CREATE TABLE `staff` (
  ...
  `department_id` int(10) UNSIGNED NOT NULL,
  `employment_type` enum('Regular / Permanent','Casual','Fixed-Term','Probationary','Project-Based','Seasonal') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
